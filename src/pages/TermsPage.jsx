  ...
  return (
    <main className="page page-legal card">
      ...
      <div className="page-body">
        ...
        <p>
          Creators must additionally be legally permitted to receive income
          in their country of residence and must comply with all applicable
          tax, financial, and identity laws in their jurisdiction.
        </p>
        ...
        <p>
          ...
          sell, deliver, or provide access to creator content of any kind.
        ...
        <p>
          ...
          their cumulative tipping volume and activity over a rolling 30-day
          period. Higher tiers result in a lower platform fee, meaning
          creators keep a larger share of each tip.
        </p>
        <p>
        ...
        <p>
          In addition to the platform fee, Stripe's payment processing fee
          is charged to the fan at the time of payment. Creators do not pay
          Stripe's processing fee directly; it is included in the total
          amount charged to the fan.
        </p>
        ...
        <p>
          ...
          making a voluntary, non-refundable gift and waive any right of
          withdrawal in respect of that payment.
        </p>
        <p>
          For creator accounts (subscription to the KunTips service itself
          rather than tip transactions), the standard 14-day right of
          withdrawal applies from the date of account creation unless
          KunTips has begun providing the service with your explicit
          consent.
        </p>
        ...
        <p>
          ...
          respond within 10 business days. KunTips' decision following a
          review is final.
        </p>
        <p>
          Creators may close their account at any time by contacting
          support@kuntips.no. Any outstanding payout balance at the time of
          closure will be processed in the normal payout cycle, subject to
          Stripe's requirements and any outstanding dispute deductions.
        </p>
        ...
        <p>
          ...
          process, subject to minimum thresholds and Stripe's requirements.
        </p>
        ...
        <h2>12. Privacy</h2>
        <p>
          Our collection and use of personal data is governed by our Privacy
          Policy. By using KunTips you acknowledge and agree to the
          processing of personal data as described therein.
        </p>
        ...
        <p>
          ...
          Forbrukertvistutvalget (the Consumer Disputes Committee) in
