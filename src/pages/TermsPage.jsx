  ...
  return (
    <main className="page page-legal">
      ...
      <div className="page-body">
        ...
        <p>
          KunTips is a digital tipping platform that allows fans to send
          voluntary monetary tips to online creators. KunTips is a service
        ...
        <p>
          ...
          time. We are not liable for interruptions or delays.
        </p>

        <h2>7. User Conduct</h2>
        <p>
          You agree not to interfere with the platform, misuse the tipping
          system, attempt to access unauthorized areas, or harass creators or
          staff.
        </p>
